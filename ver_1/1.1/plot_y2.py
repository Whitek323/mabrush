...
mapping = {
    "ซ้าย บน": "./data/1.1-1.csv",
    "ซ้าย ล่าง": "./data/1.1-2.csv",
    "กลาง บน": "./data/1.2-1.csv",
    "กลาง ล่าง": "./data/1.2-2.csv",
    "ขวา บน": "./data/1.3-1.csv",
    "ขวา ล่าง": "./data/1.3-2.csv"
}
